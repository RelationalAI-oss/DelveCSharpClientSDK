...
namespace Ai.Relational.Model
{
    ...
    public partial class Area :  IEquatable<Area>, IValidatableObject
    {
        ...
        /// <param name="objtp">objtp (required) (default to ObjtpEnum.Area).</param>
        public Area(Point startPoint = default(Point), Point endPoint = default(Point), ObjtpEnum objtp = ObjtpEnum.Area)
        {
            ...
            if (objtp == null)
            {
                throw new InvalidDataException("objtp is a required property for Area and cannot be null");
            }
            else
            {
                this.Objtp = objtp;
