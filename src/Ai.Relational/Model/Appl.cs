...
namespace Ai.Relational.Model
{
    ...
    public partial class Appl : SyntaxNode,  IEquatable<Appl>, IValidatableObject
    {
        ...
        public Appl(string symbol = "", List<SyntaxNode> arguments = default(List<SyntaxNode>), Range range = default(Range), bool missing = false, bool error = false, string objtp = "") : base(objtp)
        {
