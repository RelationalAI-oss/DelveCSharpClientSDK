...
namespace Ai.Relational.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(CSVFileSchema), "CSVFileSchema")]
    public partial class FileSchema :  IEquatable<FileSchema>, IValidatableObject
    {
        /// <summary>
        ...
        public FileSchema(string objtp = "")
        {
            // to ensure "objtp" is required (not null)
            if (objtp == null)
            {
                throw new InvalidDataException("objtp is a required property for FileSchema and cannot be null");
            }
            else
            {
                this.Objtp = objtp;
        ...
        {
            return this.Equals(input as FileSchema);
        }

        /// <summary>
        /// Returns true if FileSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of FileSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FileSchema input)
        {
            if (input == null)
                return false;
