...
namespace Ai.Relational.Model
{
    ...
    public partial class Range :  IEquatable<Range>, IValidatableObject
    {
        ...
        /// <param name="objtp">objtp (required) (default to ObjtpEnum.Range).</param>
        public Range(AnyValue input = default(AnyValue), Area area = default(Area), ModelInt startByte = default(ModelInt), ModelInt endByte = default(ModelInt), ObjtpEnum objtp = ObjtpEnum.Range)
        {
            ...
            if (objtp == null)
            {
                throw new InvalidDataException("objtp is a required property for Range and cannot be null");
            }
            else
            {
                this.Objtp = objtp;
