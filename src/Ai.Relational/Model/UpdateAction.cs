...
namespace Ai.Relational.Model
{
    ...
    public partial class UpdateAction : Action,  IEquatable<UpdateAction>, IValidatableObject
    {
        ...
        public UpdateAction(RelKey rel = default(RelKey), List<PairAnyValueAnyValue> updates = default(List<PairAnyValueAnyValue>), List<PairAnyValueAnyValue> delta = default(List<PairAnyValueAnyValue>), string objtp = "") : base(objtp)
        {
