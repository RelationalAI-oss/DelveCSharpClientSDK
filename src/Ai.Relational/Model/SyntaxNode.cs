...
namespace Ai.Relational.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(Token), "Token")]
    [JsonSubtypes.KnownSubType(typeof(Appl), "Appl")]
    [JsonSubtypes.KnownSubType(typeof(Literal), "Literal")]
    public partial class SyntaxNode :  IEquatable<SyntaxNode>, IValidatableObject
    {
        /// <summary>
        ...
        public SyntaxNode(string objtp = "")
        {
            // to ensure "objtp" is required (not null)
            if (objtp == null)
            {
                throw new InvalidDataException("objtp is a required property for SyntaxNode and cannot be null");
            }
            else
            {
                this.Objtp = objtp;
        ...
        {
            return this.Equals(input as SyntaxNode);
        }

        /// <summary>
        /// Returns true if SyntaxNode instances are equal
        /// </summary>
        /// <param name="input">Instance of SyntaxNode to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SyntaxNode input)
        {
            if (input == null)
                return false;
