...
namespace Ai.Relational.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(WrappedType), "WrappedType")]
    [JsonSubtypes.KnownSubType(typeof(ConstantType), "ConstantType")]
    public partial class DBType :  IEquatable<DBType>, IValidatableObject
    {
        /// <summary>
        ...
        public DBType(string objtp = "")
        {
            // to ensure "objtp" is required (not null)
            if (objtp == null)
            {
                throw new InvalidDataException("objtp is a required property for DBType and cannot be null");
            }
            else
            {
                this.Objtp = objtp;
        ...
        {
            return this.Equals(input as DBType);
        }

        /// <summary>
        /// Returns true if DBType instances are equal
        /// </summary>
        /// <param name="input">Instance of DBType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DBType input)
        {
            if (input == null)
                return false;
