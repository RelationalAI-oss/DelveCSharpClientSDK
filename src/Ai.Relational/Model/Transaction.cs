...
namespace Ai.Relational.Model
{
    ...
    public partial class Transaction :  IEquatable<Transaction>, IValidatableObject
    {
        ...
        /// <param name="objtp">objtp (required) (default to ObjtpEnum.Transaction).</param>
        public Transaction(string dbname = "", ModeEnum mode = ModeEnum.OPEN, bool _readonly = false, List<LabeledAction> actions = default(List<LabeledAction>), bool abort = false, ObjtpEnum objtp = ObjtpEnum.Transaction)
        {
            ...
            if (objtp == null)
            {
                throw new InvalidDataException("objtp is a required property for Transaction and cannot be null");
            }
            else
            {
                this.Objtp = objtp;
