...
namespace Com.RelationalAI.Model
{
    ...
    public partial class QueryAction : Action,  IEquatable<QueryAction>, IValidatableObject
    {
        ...
        public QueryAction(List<Relation> inputs = default(List<Relation>), List<string> outputs = default(List<string>), List<string> persist = default(List<string>), Source source = default(Source), string type = "") : base(type)
        {
