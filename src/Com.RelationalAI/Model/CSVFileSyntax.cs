...
namespace Com.RelationalAI.Model
{
    ...
    public partial class CSVFileSyntax : FileSyntax,  IEquatable<CSVFileSyntax>, IValidatableObject
    {
        ...
        public CSVFileSyntax(ModelInt datarow = default(ModelInt), string delim = "", string escapechar = "", List<string> header = default(List<string>), ModelInt headerRow = default(ModelInt), bool ignorerepeated = false, List<string> missingstrings = default(List<string>), bool normalizenames = false, string quotechar = "", string type = "") : base(type)
        {
